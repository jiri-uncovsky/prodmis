...
import osu.kip.prodmis.config.WebMvcJSONConfiguration;
import osu.kip.prodmis.http.converter.json.BindingResultSerializer;
import osu.kip.prodmis.http.converter.json.ConversionServiceBeanSerializerModifier;
import osu.kip.prodmis.http.converter.json.DataBinderBeanDeserializerModifier;
import osu.kip.prodmis.http.converter.json.FieldErrorSerializer;
