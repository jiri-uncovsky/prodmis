...
import osu.kip.prodmis.service.impl.ProductServiceImpl;
...
privileged aspect ProductServiceImpl_Roo_Service_Impl {
    ...
    public Long ProductServiceImpl.countByOrganizationId(Long id) {
        return productRepository.countByOrganizationId(id);
    }
    
    public Long ProductServiceImpl.countByProductManagerId(Long id) {
        return productRepository.countByProductManagerId(id);
    }
    
    public Page<Product> ProductServiceImpl.findAllByOrganization(Organization organizationField, GlobalSearch globalSearch, Pageable pageable) {
        return productRepository.findAllByOrganization(organizationField, globalSearch, pageable);
    }
    
    public Page<Product> ProductServiceImpl.findAllByUserLogin(UserLogin userLoginField, GlobalSearch globalSearch, Pageable pageable) {
        return productRepository.findAllByUserLogin(userLoginField, globalSearch, pageable);
    }
